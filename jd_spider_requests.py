...
class JdSeckill(object):
    def __init__(self):
        ...
        # 初始化信息
        uSku_id = input('   请输入指定sku_id，默认为茅台id:')
        self.sku_id = uSku_id if uSku_id else global_config.getRaw('config', 'sku_id')
        self.seckill_num = 2
        ...
        self.nick_name = None
        print('您选择的商品名称为:{}'.format(self.get_sku_title()))
